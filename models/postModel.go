...
type Post struct {
	...
	CommunityId uint8  `db:"community_id" json:"community_id"` // 社区ID
	Status      uint8  `db:"status" json:"status"`             // 帖子状态(默认1)
	CreateTime  uint8  `db:"create_time" json:"create_time"`   // 创建时间
	UpdateTime  uint8  `db:"update_time" json:"update_time"`   // 更新时间
}
